...
namespace Sphereon.SDK.Extraction.Named.Entity.Api
{
    ...
    public interface INamedEntityExtractionApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Job> AddInputTextAsync (string jobid, TextInput textInput);
        ...
        System.Threading.Tasks.Task<ApiResponse<Job>> AddInputTextAsyncWithHttpInfo (string jobid, TextInput textInput);
        /// <summary>
        /// Create a name entity extraction job
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Sphereon.SDK.Extraction.Named.Entity.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="jobid">jobid</param>
        /// <returns>Task of NamedEntityExtractionResponse</returns>
        System.Threading.Tasks.Task<NamedEntityExtractionResponse> GetResultAsync (string jobid);
        ...
        /// <exception cref="Sphereon.SDK.Extraction.Named.Entity.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="jobid">jobid</param>
        /// <returns>Task of ApiResponse (NamedEntityExtractionResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<NamedEntityExtractionResponse>> GetResultAsyncWithHttpInfo (string jobid);
        /// <summary>
        /// Submit name entity extraction job for processing
        /// </summary>
        /// <remarks>
        ...
        /// <param name="settings">settings</param>
        /// <returns>Task of Job</returns>
        System.Threading.Tasks.Task<Job> SubmitJobAsync (string jobid, JobSettings settings);
        ...
        /// <param name="settings">settings</param>
        /// <returns>Task of ApiResponse (Job)</returns>
        System.Threading.Tasks.Task<ApiResponse<Job>> SubmitJobAsyncWithHttpInfo (string jobid, JobSettings settings);
    ...
    public partial class NamedEntityExtractionApi : INamedEntityExtractionApi
    {
        ...
        /// <param name="textInput">textInput</param>
        /// <returns>Task of Job</returns>
        public async System.Threading.Tasks.Task<Job> AddInputTextAsync (string jobid, TextInput textInput)
        {
             ApiResponse<Job> localVarResponse = await AddInputTextAsyncWithHttpInfo(jobid, textInput);
             return localVarResponse.Data;
        ...
        /// <param name="textInput">textInput</param>
        /// <returns>Task of ApiResponse (Job)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Job>> AddInputTextAsyncWithHttpInfo (string jobid, TextInput textInput)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling NamedEntityExtractionApi->AddInputText");
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of NamedEntityExtractionResponse</returns>
        public async System.Threading.Tasks.Task<NamedEntityExtractionResponse> GetResultAsync (string jobid)
        {
             ApiResponse<NamedEntityExtractionResponse> localVarResponse = await GetResultAsyncWithHttpInfo(jobid);
             return localVarResponse.Data;
        ...
        /// <param name="jobid">jobid</param>
        /// <returns>Task of ApiResponse (NamedEntityExtractionResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<NamedEntityExtractionResponse>> GetResultAsyncWithHttpInfo (string jobid)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling NamedEntityExtractionApi->GetResult");
        ...
        /// <param name="settings">settings</param>
        /// <returns>Task of Job</returns>
        public async System.Threading.Tasks.Task<Job> SubmitJobAsync (string jobid, JobSettings settings)
        {
             ApiResponse<Job> localVarResponse = await SubmitJobAsyncWithHttpInfo(jobid, settings);
             return localVarResponse.Data;
        ...
        /// <param name="settings">settings</param>
        /// <returns>Task of ApiResponse (Job)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Job>> SubmitJobAsyncWithHttpInfo (string jobid, JobSettings settings)
        {
            // verify the required parameter 'jobid' is set
            if (jobid == null)
                throw new ApiException(400, "Missing required parameter 'jobid' when calling NamedEntityExtractionApi->SubmitJob");
