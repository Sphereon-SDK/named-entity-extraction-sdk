...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NameEntityExtraction.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instane = new NameEntityExtraction.ErrorResponse();
      //expect(instance).to.be.a(NameEntityExtraction.ErrorResponse);
    });
