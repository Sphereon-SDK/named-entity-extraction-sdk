...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NameEntityExtraction.NamedEntity();
  });
  ...
  describe('NamedEntity', function() {
    it('should create an instance of NamedEntity', function() {
      // uncomment below and update the code to test NamedEntity
      //var instane = new NameEntityExtraction.NamedEntity();
      //expect(instance).to.be.a(NameEntityExtraction.NamedEntity);
    });
    ...
    it('should have the property prob (base name: "prob")', function() {
      // uncomment below and update the code to test the property prob
      //var instane = new NameEntityExtraction.NamedEntity();
      //expect(instance).to.be();
    });
